% custom-math-symbols.sty
% by polossk, version 2.2.3.1026
% last update 2022-10-26
% github.com/polossk/Math-Symbols-in-LaTeX
%------------------------------------------------------------------------------%
% Specifically for VSCode LaTeX Workshop Extension
% In order to enable hover preview
%------------------------------------------------------------------------------%
%-Math-Fonts-------------------------------------------------------------------%
%------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------%
\newcommand\mta{{\mathbb A}}                               % tensor A
\newcommand\mtb{{\mathbb B}}                               % tensor B
\newcommand\mtc{{\mathbb C}}                               % tensor C
\newcommand\mtd{{\mathbb D}}                               % tensor D
\newcommand\mte{{\mathbb E}}                               % tensor E
\newcommand\mtf{{\mathbb F}}                               % tensor F
\newcommand\mtg{{\mathbb G}}                               % tensor G
\newcommand\mth{{\mathbb H}}                               % tensor H
\newcommand\mti{{\mathbb I}}                               % tensor I
\newcommand\mtj{{\mathbb J}}                               % tensor J
\newcommand\mtk{{\mathbb K}}                               % tensor K
\newcommand\mtl{{\mathbb L}}                               % tensor L
\newcommand\mtm{{\mathbb M}}                               % tensor M
\newcommand\mtn{{\mathbb N}}                               % tensor N
\newcommand\mto{{\mathbb O}}                               % tensor O
\newcommand\mtp{{\mathbb P}}                               % tensor P
\newcommand\mtq{{\mathbb Q}}                               % tensor Q
\newcommand\mtr{{\mathbb R}}                               % tensor R
\newcommand\mts{{\mathbb S}}                               % tensor S
\newcommand\mtt{{\mathbb T}}                               % tensor T
\newcommand\mtu{{\mathbb U}}                               % tensor U
\newcommand\mtv{{\mathbb V}}                               % tensor V
\newcommand\mtw{{\mathbb W}}                               % tensor W
\newcommand\mtx{{\mathbb X}}                               % tensor X
\newcommand\mty{{\mathbb Y}}                               % tensor Y
\newcommand\mtz{{\mathbb Z}}                               % tensor Z
\newcommand\mtgamma{{\mathbbl{\Gamma}}}                    % tensor Gamma
\newcommand\mtdelta{{\mathbbl{\Delta}}}                    % tensor Delta
\newcommand\mttheta{{\mathbbl{\Theta}}}                    % tensor Theta
\newcommand\mtlambda{{\mathbbl{\Lambda}}}                  % tensor Lambda
\newcommand\mtxi{{\mathbbl{\Xi}}}                          % tensor Xi
\newcommand\mtpi{{\mathbbl{\Pi}}}                          % tensor Pi
\newcommand\mtsigma{{\mathbbl{\Sigma}}}                    % tensor Sigma
\newcommand\mtupsilon{{\mathbbl{\Upsilon}}}                % tensor Upsilon
\newcommand\mtphi{{\mathbbl{\Phi}}}                        % tensor Phi
\newcommand\mtpsi{{\mathbbl{\Psi}}}                        % tensor Psi
\newcommand\mtomega{{\mathbbl{\Omega}}}                    % tensor Omega
%------------------------------------------------------------------------------%
%-[M]ath-[V]ector-Defination-[T]ransposed--------------------------------------%
%------------------------------------------------------------------------------%
\newcommand\mmat{{{\mathbf A}^{\mathrm T}}}                % matrix A^T
\newcommand\mmbt{{{\mathbf B}^{\mathrm T}}}                % matrix B^T
\newcommand\mmct{{{\mathbf C}^{\mathrm T}}}                % matrix C^T
\newcommand\mmdt{{{\mathbf D}^{\mathrm T}}}                % matrix D^T
\newcommand\mmet{{{\mathbf E}^{\mathrm T}}}                % matrix E^T
\newcommand\mmft{{{\mathbf F}^{\mathrm T}}}                % matrix F^T
\newcommand\mmgt{{{\mathbf G}^{\mathrm T}}}                % matrix G^T
\newcommand\mmht{{{\mathbf H}^{\mathrm T}}}                % matrix H^T
\newcommand\mmit{{{\mathbf I}^{\mathrm T}}}                % matrix I^T
\newcommand\mmjt{{{\mathbf J}^{\mathrm T}}}                % matrix J^T
\newcommand\mmkt{{{\mathbf K}^{\mathrm T}}}                % matrix K^T
\newcommand\mmlt{{{\mathbf L}^{\mathrm T}}}                % matrix L^T
\newcommand\mmmt{{{\mathbf M}^{\mathrm T}}}                % matrix M^T
\newcommand\mmnt{{{\mathbf N}^{\mathrm T}}}                % matrix N^T
\newcommand\mmot{{{\mathbf O}^{\mathrm T}}}                % matrix O^T
\newcommand\mmpt{{{\mathbf P}^{\mathrm T}}}                % matrix P^T
\newcommand\mmqt{{{\mathbf Q}^{\mathrm T}}}                % matrix Q^T
\newcommand\mmrt{{{\mathbf R}^{\mathrm T}}}                % matrix R^T
\newcommand\mmst{{{\mathbf S}^{\mathrm T}}}                % matrix S^T
\newcommand\mmtt{{{\mathbf T}^{\mathrm T}}}                % matrix T^T
\newcommand\mmut{{{\mathbf U}^{\mathrm T}}}                % matrix U^T
\newcommand\mmvt{{{\mathbf V}^{\mathrm T}}}                % matrix V^T
\newcommand\mmwt{{{\mathbf W}^{\mathrm T}}}                % matrix W^T
\newcommand\mmxt{{{\mathbf X}^{\mathrm T}}}                % matrix X^T
\newcommand\mmyt{{{\mathbf Y}^{\mathrm T}}}                % matrix Y^T
\newcommand\mmzt{{{\mathbf Z}^{\mathrm T}}}                % matrix Z^T
\newcommand\mmgammat{{{\bm \Gamma}^{\mathrm T}}}           % matrix Gamma^T
\newcommand\mmdeltat{{{\bm \Delta}^{\mathrm T}}}           % matrix Delta^T
\newcommand\mmthetat{{{\bm \Theta}^{\mathrm T}}}           % matrix Theta^T
\newcommand\mmlambdat{{{\bm \Lambda}^{\mathrm T}}}         % matrix Lambda^T
\newcommand\mmxit{{{\bm \Xi}^{\mathrm T}}}                 % matrix Xi^T
\newcommand\mmpit{{{\bm \Pi}^{\mathrm T}}}                 % matrix Pi^T
\newcommand\mmsigmat{{{\bm \Sigma}^{\mathrm T}}}           % matrix Sigma^T
\newcommand\mmupsilont{{{\bm \Upsilon}^{\mathrm T}}}       % matrix Upsilon^T
\newcommand\mmphit{{{\bm \Phi}^{\mathrm T}}}               % matrix Phi^T
\newcommand\mmpsit{{{\bm \Psi}^{\mathrm T}}}               % matrix Psi^T
\newcommand\mmomegat{{{\bm \Omega}^{\mathrm T}}}           % matrix Omega^T
%------------------------------------------------------------------------------%
\newcommand\mvzero{{\mathbf 0}}                            % vector 0
\newcommand\mmzero{{\mathbf 0}}                            % matrix 0
\newcommand\mtzero{{\mathbbl{0}}}                          % tensor 0
\newcommand\mvone{{\mathbf 1}}                             % vector 1
\newcommand\mmone{{\mathbf 1}}                             % matrix 1
\newcommand\mtone{{\mathbbl{1}}}                           % tensor 1
%------------------------------------------------------------------------------%
%-Useful-Operators-------------------------------------------------------------%
%------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------%
%---Function-Vaules-at-Exact-Point---------------------------------------------%
%------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------%
%---Vector(Sequence)-Generator-------------------------------------------------%
%------------------------------------------------------------------------------%
\newcommand\mvct[2]{{ ({#1}_1, {#1}_2, \ldots, {#1}_{#2}) }}
\newcommand\mvctz[2]{{ ({#1}_0, {#1}_1, \ldots, {#1}_{#2}) }}
\newcommand\mvctt[2]{{ \mvct{#1}{#2}^{\mathrm T} }}
\newcommand\mvctzt[2]{{ \mvctz{#1}{#2}^{\mathrm T} }}
%------------------------------------------------------------------------------%
